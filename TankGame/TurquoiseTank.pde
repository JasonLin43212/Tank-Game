public class TurquoiseTank extends Tank{
  ...
  public TurquoiseTank(float x, float y, int id) {
    super(x, y, 0, id, color(60, 119, 102), 1, 180, 1, 0, x, y);
  }
  ...
  public void shoot() {
    if (currentBullet < maxBullet && shootCoolDown == 0 && (predictShooting(player).equals("player")||(int)(random(600))==0)) {
